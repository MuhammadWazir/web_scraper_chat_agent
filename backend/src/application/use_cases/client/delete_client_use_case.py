...
class DeleteClientUseCase:
    ...
    def execute(self, client_ip: str) -> bool:
        """
        Delete a client and their associated Qdrant collection
        
        Args:
            client_ip: The client IP to delete
        ...
        # Delete from Qdrant (collection name is based on client_ip)
        ...
        success = self.client_repository.delete(client_ip)
        
        if not success:
            raise ValueError(f"Failed to delete client {client_ip} from database")
